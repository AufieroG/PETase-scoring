...
- `PET_run.py` — scores the sequences in `sequences.fasta` using the trained model
- `PET_train.py` — trains the model from `dataset.csv`
- `PETase_model.json` — pre-trained XGBoost model
- `dataset.csv` — training data
- `sequences.fasta` — input sequences to score
